...
function AccountPage() {
  ...
  return errorHappened ? (
    ...
    <div style={{ height: '100%', width: '100%', position: 'fixed', backgroundColor: 'black' }}>
      ...
      >
        <Container>
          <div
            id='personal-data'
            style={{ display: 'flex', width: '100%', height: 'auto', flexDirection: 'row', marginTop: '7.5vh' }}
          >
            <span
              id='pfp-pic'
              style={{
          ...
          <div style={{ display: 'flex', columnGap: '5%', flexFlow: 'row wrap', justifyContent: 'space-around' }}>
            ...
            >
              <Card.Body>
                ...
                <Card.Text>Find out the next steps to your weight.</Card.Text>
              </Card.Body>
            </Card>
            {/* </div> */}
            ...
            >
              <Card.Body>
                ...
                <Card.Text>Find out your sleep goal for the future.</Card.Text>
              </Card.Body>
            </Card>
            {/* </div> */}
          </div>
