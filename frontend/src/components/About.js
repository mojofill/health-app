        ...
        >
          ...
          <Card>
            <Card.Body style={{ backgroundColor: 'black' }}>
              ...
              <Card.Link href='https://github.com/Vncero' target='_blank'>
                GitHub (Vncero)
              </Card.Link>
            </Card.Body>
          </Card>
          <Card>
            <Card.Body style={{ backgroundColor: 'black' }}>
              ...
              <Card.Link href='https://github.com/mojofill' target='_blank'>
                GitHub (mojofill)
              </Card.Link>
              <Card.Link href='https://replit.com/@triplemilkshake' target='_blank'>
                Replit (triplemilkshake)
              </Card.Link>
            </Card.Body>
          </Card>
          <Card>
            <Card.Body style={{ backgroundColor: 'black' }}>
              ...
              <Card.Link href='https://github.com/BananasAmIRite' target='_blank'>
                GitHub (BananasAmIRite)
              </Card.Link>
            </Card.Body>
          </Card>
          <Card>
            <Card.Body style={{ backgroundColor: 'black' }}>
              ...
              <Card.Link href='https://github.com/EricFor' target='_blank'>
                GitHub (EricFor)
              </Card.Link>
            </Card.Body>
          </Card>
